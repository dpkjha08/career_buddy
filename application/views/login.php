...
<div class="login-form">    
    <form action="<?php echo site_url('Login/give_access');?>" method="post">
    ...
    <div class="text-center small">Don't have an account? <a href="<?php echo site_url('Signup'); ?>">Sign up</a></div>
</div>
</body>
</html>                                		                            